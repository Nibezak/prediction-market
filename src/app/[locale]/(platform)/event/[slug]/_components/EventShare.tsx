...
import { CheckIcon, ExternalLinkIcon, LinkIcon, ShareIcon } from 'lucide-react'
    ...
    >
      ...
      >
        ...
        <DropdownMenuContent
          ...
          sideOffset={8}
          collisionPadding={16}
          className="w-48 border border-border bg-background p-0 text-foreground shadow-xl"
        >
          ...
          >
            ...
            {shareSuccess || copiedKey === 'event' ? 'Copied!' : 'Copy link'}
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
    </div>
