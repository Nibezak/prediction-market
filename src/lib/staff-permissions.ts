...
const groups = {
  ...
  Finance: ['finance.view', 'finance.ledger.view', 'finance.deposit.review', 'finance.deposit.adjust', 'finance.withdrawal.review', 'finance.withdrawal.approve', 'finance.withdrawal.reject', 'finance.refund.create', 'finance.reversal.create', 'finance.reconcile'],
